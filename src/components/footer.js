...
import LogoImg from '../images/Shape-withe.svg'
            ...
            <div className="container is-narrow">
                ...
                <div className="social-icons">
                    <p className="field">
                        ...
                        <a className="button is-medium" href="https://dribbble.com/mattfarley" target="_blank">
                            <span className="icon is-small">
                                <svg className="svg-inline--fa fa-dribbble fa-w-16 fa-fw"
                        ...
                        <a className="button is-medium" href="https://www.linkedin.com/in/matthew-farley-32526014/" target="_blank">
                            <span className="icon is-small">
                        ...
                        <a className="button is-medium" href="https://angel.co/mattfarley" target="_blank">
                            <span className="icon is-small">
                                <svg className="svg-inline--fa fa-angellist fa-w-14 fa-fw"
                                   aria-hidden="true" focusable="false" data-prefix="fab"
                         ...
                         {/*<i class="fab fa-angellist fa-fw"></i> */}
                            </span>
                        </a>
                        <a className="button is-medium" href="https://www.producthunt.com/@farleymatters" target="_blank">
                            <span className="icon is-small">
                                <svg className="svg-inline--fa fa-product-hunt fa-w-16 fa-fw"
                                aria-hidden="true" focusable="false" data-prefix="fab"
                                data-icon="product-hunt" role="img"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                data-fa-i2svg="">
                                    <path fill="currentColor" d="M326.3 218.8c0 20.5-16.7 37.2-37.2 37.2h-70.3v-74.4h70.3c20.5 0 37.2 16.7 37.2 37.2zM504 256c0 137-111 248-248 248S8 393 8 256 119 8 256 8s248 111 248 248zm-128.1-37.2c0-47.9-38.9-86.8-86.8-86.8H169.2v248h49.6v-74.4h70.3c47.9 0 86.8-38.9 86.8-86.8z"/></svg>
